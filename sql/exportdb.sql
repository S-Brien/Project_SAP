...
INSERT INTO `Staff` VALUES 
 ...
 DROP user 'projectmanager'@'localhost';

 CREATE USER 'projectmanager'@'localhost' IDENTIFIED BY 'password';

 GRANT ALL ON `project`.* TO 'projectmanager'@'localhost' IDENTIFIED BY 'password';

 -- for mysql 8.0 or greater
 -- GRANT ALL ON `project`.* TO 'projectmanager'@'localhost';
